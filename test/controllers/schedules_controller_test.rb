...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference("Schedule.count") do
      post schedules_url, params: { schedule: { content: @schedule.content, send_at: @schedule.send_at } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { content: @schedule.content, send_at: @schedule.send_at } }
